Public Class frmEnterCA
    Dim RecordPosition As Integer
    Private Sub frmEnterCA_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    Private Sub btnEnterCA_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnEnterCA.Click
        If txtScore.Text = "" Then
            MsgBox("Continuos Assessment score cannot be empty", MsgBoxStyle.Exclamation)
            Exit Sub
        End If
